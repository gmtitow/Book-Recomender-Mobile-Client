...
public class BookItemFragment extends AbstractFragment implements BookItemView, ReviewListener, DialogAddToReadFragment.Communicator {
    ...
    public void setupViews(final BookInfo book) {
        ...
        mReviewAdapter = new ReviewListAdapter(getActivity(), book.getReviews().getData(),
                BookApplication.INSTANCE.getDataStore().getUserId(),
                this, book, addToReadListener,addReviewListener, list.size() != 0);
...
//        mReviewAdapter.getReviewAddButton().setVisibility(View.VISIBLE);
        mReviewAdapter.setAddReviewVisibility(View.VISIBLE);
    }

    public void hideCreateReviewBtn() {
//        mReviewAdapter.getReviewAddButton().setVisibility(View.GONE);
        mReviewAdapter.setAddReviewVisibility(View.GONE);
    }
